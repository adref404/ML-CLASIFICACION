...
def split_data(X, y, test_size=0.2, random_state=42):
    ...
    print(f"[INFO] Conjunto de Prueba: {X_test.shape[0]} muestras ({test_size*100:.0f}%)")
...
def plot_results(results_df):
    ...
    sns.heatmap(metrics_data, annot=True, fmt='.4f', cmap='YlGnBu', 
                xticklabels=results_df['Modelo'], yticklabels=metrics,
...
def main():
    ...
    trained_models, cv_scores = train_with_cross_validation(models, X_train, y_train, cv=5)
